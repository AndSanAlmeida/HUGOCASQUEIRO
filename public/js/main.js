...
__webpack_require__(/*! imagesloaded/imagesloaded.pkgd */ "./node_modules/imagesloaded/imagesloaded.pkgd.js");
...
function sticky() {
  $(window).scroll(function () {
    ...
    var $hcW = $('.hcW');
    var $hcG = $('.hcG');
    $(this).scrollTop() > 300 ? ($hcW.hide(), $hcG.show(), $nav.addClass("sticky"), $nav.removeClass("navbar")) : ($hcW.show(), $hcG.hide(), $nav.removeClass("sticky"), $nav.addClass("navbar"));
  });
} // ====================================================
// Responsive Navbar
// ====================================================
...
function slider() {
  var timer = setInterval(move_to_next, 5000),
      ...
      $dots = $slider.find(".carousel-dots"); // Make the first slider active

  $sliderLi.first().addClass("active"); // Count and add nav dots

  $sliderLi.each(function () {
    $dots.append("<li/>");
  });
  $dots.find("li").first().addClass("active"); // Change slider on dot click
  ...
  function move_to_next() {
    var i;
    if ($sliderUl.find("li").last().hasClass("active")) i = 0;else i = $sliderUl.find("li.active").next().index();
    next(i);
  }
...
function sliderReviews(options) {
  ...
  this.slideNext = function () {
    ...
    if (document.body.clientWidth) {
      ...
      var value = Privates.sel.position * 100;
      Privates.sel.slider_wrap.style.transform = "translateX(-".concat(value, "%)");
    } else {
      if (Privates.sel.position >= Privates.sel.slides.length - 1) {
        Privates.sel.position = 0;
      }

      var _value = Privates.sel.position * 50;

      Privates.sel.slider_wrap.style.transform = "translateX(-".concat(_value, "%)");
    }
  };
  ...
  this.slidePrev = function () {
    ...
    if (document.body.clientWidth) {
      ...
      var _value2 = Privates.sel.position * 50;

      Privates.sel.slider_wrap.style.transform = "translateX(-".concat(_value2, "%)");
    }
  }; // this.test = () => {
  //     console.log('test');
  // }
  ...
  if (Privates.sel.next_button != undefined && Privates.sel.next_button != null) {
    Privates.sel.next_button.addEventListener('click', function () {
      _this.slideNext();
    });
  }

  if (Privates.sel.prev_button != undefined && Privates.sel.next_button != null) {
    Privates.sel.prev_button.addEventListener('click', function () {
      _this.slidePrev();
    });
...
/***/ 0:
/*!******************************************************************************************!*\
  !*** multi ./resources/js/main.js ./resources/sass/main.scss ./resources/sass/auth.scss ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\laragon\www\HUGOCASQUEIRO\resources\js\main.js */"./resources/js/main.js");
__webpack_require__(/*! C:\laragon\www\HUGOCASQUEIRO\resources\sass\main.scss */"./resources/sass/main.scss");
module.exports = __webpack_require__(/*! C:\laragon\www\HUGOCASQUEIRO\resources\sass\auth.scss */"./resources/sass/auth.scss");
