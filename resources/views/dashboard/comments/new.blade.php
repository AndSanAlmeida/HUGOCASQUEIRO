...
@section('title', ucfirst(trans('messages.new-comment')) )
@section('content')
<main class="main">
    ...
    <form action="{{route('dashboard.save-comment', app()->getLocale())}}" method="POST" enctype="multipart/form-data">
    @csrf
    
        <div class="tab-content">
            <div class="tab-pane active" id="pt" role="tabpanel">
                <div class="form-group">
                    <label for="name">{{ucfirst(trans('messages.name'))}}</label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="body_pt" id="body_pt" cols="30" rows="10"></textarea>
                </div>
            </div>
            <div class="tab-pane" id="en" role="tabpanel">
                <div class="form-group">
                    <label for="body_en">{{ucfirst(trans('messages.description'))}}</label>
                    <textarea class="form-control" name="body_en" id="body_en" cols="30" rows="10"></textarea>
                </div>
            </div>
            <div class="tab-pane" id="fr" role="tabpanel">
                <div class="form-group">
                    <label for="body_fr">{{ucfirst(trans('messages.description'))}}</label>
                    <textarea class="form-control" name="body_fr" id="body_fr" cols="30" rows="10"></textarea>
                </div>
            </div>
