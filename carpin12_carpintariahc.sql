...
CREATE DATABASE IF NOT EXISTS `carpin12_carpintariahc` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `carpin12_carpintariahc`;
...
REPLACE INTO `services` (`id`, `title`, `body`, `identifier`, `created_at`, `updated_at`) VALUES
	(1, '{"en": "\\"Nome em ingl\\\\u00eas\\"", "fr": "\\"Nome em franc\\\\u00eas\\"", "pt": "\\"Carpintaria Interior\\""}', '{"en": "\\"%3Cp%3Econteudo+em+ingl%C3%AAs%3C%2Fp%3E\\"", "fr": "\\"%3Cp%3Efthftyhft%3C%2Fp%3E%3Cp%3E%3Cbr%3E%3C%2Fp%3E\\"", "pt": "\\"%3Cul%3E%3Cli%3EPortas+de+interior+e+portas+de+entrada%3C%2Fli%3E%3Cli%3EJanelas+em+madeira+e+PVC%3C%2Fli%3E%3Cli%3ERoupeiros%2C+arm%C3%A1rios+e+closets%3C%2Fli%3E%3Cli%3EM%C3%B3veis+de+casa+de+banho%3C%2Fli%3E%3Cli%3ETodo+o+tipo+de+mobili%C3%A1rio+sobre+medida+%28mesas%2C+camas%2C+entre+outros%E2%80%A6%29%3C%2Fli%3E%3C%2Ful%3E%3Cp%3E%3Cbr%3E%3C%2Fp%3E\\""}', 1, '2019-12-21 17:01:32', '2020-01-06 19:31:04'),
